 ...
 * 
 */
package com.thinkgem.javamg.modules.act.service.ext;
...
import com.thinkgem.javamg.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.thinkgem.javamg.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.thinkgem.javamg.modules.sys.entity.User(null, userId)))){
